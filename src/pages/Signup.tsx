      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-stone-600">
            Join the context-aware network
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignup}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="name" name="name" type="text" required className="mt-1" value={formData.name} onChange={handleChange} />
            </div>
            <div>
            ...
            <div>
              ...
              <Input id="confirmPassword" name="confirmPassword" type="password" required className="mt-1" value={formData.confirmPassword} onChange={handleChange} />
            </div>
          </div>
